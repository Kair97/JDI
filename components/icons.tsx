/** Единый набор SVG-иконок (стиль lucide, stroke 2). Без эмодзи в роли иконок. */
...
export function CartIcon({ className = 'h-5 w-5' }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      ...
      <path d="M2.05 2.05h2l2.66 12.42a2 2 0 0 0 2 1.58h9.78a2 2 0 0 0 1.95-1.57L23 6H6.16" />
    </svg>
  );
}
...
export function SparklesIcon({ className = 'h-5 w-5' }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      <path d="m12 3 1.9 5.4a2 2 0 0 0 1.3 1.3L20.6 11.6l-5.4 1.9a2 2 0 0 0-1.3 1.3L12 20.2l-1.9-5.4a2 2 0 0 0-1.3-1.3L3.4 11.6l5.4-1.9a2 2 0 0 0 1.3-1.3L12 3Z" />
