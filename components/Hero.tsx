        ...
        <div>
          ...
          <Reveal delay={0.08}>
            <h1 className="mt-5 text-ink">
              ...
              <span className="block font-display text-4xl font-extrabold leading-[1.12] text-emerald sm:text-5xl lg:text-6xl">
                {h.headlineLine2}
              </span>
            </h1>
          </Reveal>
          ...
          <Reveal delay={0.3}>
            <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
              <a
                ...
                className="inline-flex min-h-[52px] items-center justify-center gap-2.5 whitespace-nowrap rounded-full bg-emerald px-7 text-base font-semibold text-white shadow-lg shadow-emerald/25 transition hover:-translate-y-0.5 hover:bg-emerald-bright hover:shadow-xl hover:shadow-emerald/30"
              >
                <WhatsAppIcon />
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex min-h-[52px] items-center justify-center gap-2.5 whitespace-nowrap rounded-full bg-[#3B82F6] px-7 text-base font-semibold text-white shadow-lg shadow-blue-500/25 transition hover:-translate-y-0.5 hover:bg-[#2563EB] hover:shadow-xl"
              >
                <TelegramIcon />
